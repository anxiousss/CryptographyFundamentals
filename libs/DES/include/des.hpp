...
namespace des {
    ...
    public:
        ...
        std::vector<unsigned int> shift_table = {1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1};

        std::vector<unsigned int> PC2 = {14, 17, 11, 24, 1, 5,
                                        3, 28, 15, 6, 21, 10,
                                        23, 19, 12, 4, 26, 8,
                                        16, 7, 27, 20, 13, 2,
                                        41, 52, 31, 37, 47, 55,
    ...
    private:
        ...
        std::vector<std::vector<std::vector<unsigned int>>> S_BLOCKS = {
                {
    ...
    private:
        ...
        std::vector<unsigned int> IP_INV = {
