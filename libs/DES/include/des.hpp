...
namespace des {
    ...
    public:
        static constexpr std::array<unsigned int, 56> PC1 = {57, 49, 41, 33, 25, 17, 9,
                                                             1, 58, 50, 42, 34, 26, 18,
                                                             10, 2, 59, 51, 43, 35, 27,
                                                             19, 11, 3, 60, 52, 44, 36,
        ...
        static constexpr std::array<unsigned int, 16> shift_table = {1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1};

        static constexpr std::array<unsigned int, 48> PC2 = {14, 17, 11, 24, 1, 5,
                                                             3, 28, 15, 6, 21, 10,
                                                             23, 19, 12, 4, 26, 8,
                                                             16, 7, 27, 20, 13, 2,
                                                             41, 52, 31, 37, 47, 55,
    ...
    private:
        ...
        static constexpr std::array<unsigned int, 32> P_BLOCK = {
        ...
        static constexpr std::array<std::array<std::array<unsigned int, 16>, 4>, 8> S_BLOCKS = {{
               {{
    ...
    private:
        static constexpr std::array<unsigned int, 64> IP = {
        ...
        static constexpr std::array<unsigned int, 64> IP_INV = {
    ...
    public:
        DES(const std::vector<std::byte>& key, std::shared_ptr<DesRoundKeyGeneration> des_round_key_generation,
            std::shared_ptr<FeistelTransformation> feistel_transformation);
